...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~0udmAbra#qtsl2c4-yaR_v-XYKYh-kCzRvLNNkdl-BZBU4NV_CBM",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "small-xᴅ",
...
// make true if you want auto reply on status 
        ...
        AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*Just seen ur status ❤️‍🔥,😆*",
...
OWNER_NAME: process.env.OWNER_NAME || "small ᴋɪɴɢ",
// add bot owner name
